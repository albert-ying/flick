...
void x_screen_draw_cursor(screen_t scr, int x, int y, int size, const char *fill_color, const char *border_color, int border_size, float pulse_hz, float velocity);
