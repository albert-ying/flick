...
struct platform {
	...
	void (*screen_draw_cursor)(screen_t scr, int x, int y, int size, const char *fill_color, const char *border_color, int border_size, float pulse_hz);
	void (*screen_draw_circle)(screen_t scr, int cx, int cy, int radius, int thickness, const char *color);
