...
RELFLAGS=-Wl,-adhoc_codesign -framework cocoa -framework carbon -framework QuartzCore

all: $(OBJECTS)
	-mkdir bin
	$(CC) -o bin/flick $(OBJECTS) -framework cocoa -framework carbon -framework QuartzCore
	./codesign/sign.sh
rel: clean
